export default function BaseModal({ toggleModal }) {
  return (
    <div className="absolute w-full bg-black bg-opacity-40 h-screen top-0 left-0 flex justify-center px-8">
      <div className="p-4 bg-white self-start my-32 max-w-screen-md text-black rounded-md">
        <div className="text-black">
          <h1 className="text-2xl mb-1 font-semibold">About:</h1>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold">Removing a city</h2>
          <p>
        ...
        <button
          onClick={toggleModal}
          className="text-white mt-8 bg-weather-primary py-2 px-6 rounded-md"
        >
          Close
        </button>
      </div>
